...
export const REAL_LETTERS = {
    john: (handleTextTriggerOnClick) => (
        <>
            ...
            letter, we can have all sorts of HTML elements or React components.
            For example, to go into a new line, we can use a line break &lt;br
            /&gt; like this.
            <br />
            Or use 2 line breaks &lt;br /&gt; &lt;br /&gt; for clear separation
            between paragraphs like so.
            <br />
            <br />
            Additionally, I have created predefined class names:
            <br />
            <li>
                <strong>text-image-trigger</strong>: to open an image or a GIF
                within the letter. For example, &quot;this is a{" "}
                <a
                ...
                <a
                    className="text-image-trigger"
                    onClick={() => handleTextTriggerOnClick(ItsAboutTimeGIF)}
                >
                    meme GIF
                </a>
                {""} like so. Oh, and don&apos;t forget to import your images
                before you use them.
            </li>
            <li>
                <strong>important-note</strong>: to add a curly arrow pointing
                to the emphasied text, like{" "}
                <span className="important-note">this important text</span>. We
                can also use it with <strong>text-image-trigger</strong> like{" "}
                <a
                ...
                . Please note that the curly arrow can be overlapped with the
                text on the next line, so use it sparingly.
            </li>
            <li>
                <strong>vietnamese-text</strong>: to type Vietnamese words, for
                example, &quot;
                <span className="vietnamese-text">Đây là Tiếng Việt</span>
                &quot;.
            </li>
            <li>
                <strong>song-link</strong>: to add a link to a song. Here&apos;s
                my {"  "}
                <a
            ...
            <li>
                <strong>signature</strong>: to add your signature, for example,{" "}
                <span className="signature">T.D.</span>
            </li>
            <br />
            <br />
            Feel free to customise the letter to suit your needs. And don&apos;t
            forget to give me proper credit when you use this project. Thanks!
        </>
    ),
    emily: (handleTextTriggerOnClick) => (
        <>
            Dear Emily,
            <br />
            <br />
...
/**
 * @desc A fake letter component.
 * @param {function} handleTextTriggerOnClick - function to handle text trigger on click
 * @return {JSX.Element} the fake letter template
 */
export const FAKE_LETTER = (handleTextTriggerOnClick) => (
    <>
